...
const pages = [
  { href: "/privacy", label: site.privacy, icon: "shield" },
  { href: "/terms", label: site.terms, icon: "file-text" },
  { href: "/account-deletion", label: site.accountDeletion, icon: "user-x" },
] as const;
...
export default function HomePage() {
  return (
    <div className="mx-auto max-w-3xl px-4 sm:px-6 py-12 sm:py-20">
      <h1 className="text-3xl sm:text-4xl font-bold mb-3">{site.heroTitle}</h1>
